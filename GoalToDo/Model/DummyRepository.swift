...
//            guard let realmToDoList = realmToDoList else {
//                return
//            }
//            let realmToDoItems = realmToDoList.toDoItems
//            let toDoItems = Array(realmToDoItems)
//
//            toDoList.toDoItems.forEach { toDoItem1 in
//                toDoItems.forEach { toDoItem2 in
//                    if toDoItem1.uuidString == toDoItem2.uuidString {
//                        updateToDoItem(toDoItem: toDoItem1)
//                    } else {
//                        appendToDoItem(toDoItem: toDoItem1)
//                    }
//                }
//            }
...
//    }
//
//    func appendToDoItem(toDoItem: ToDoList.ToDoItem) {
//        try! realm.write {
//            let realmToDoItem = toDoItem.managedObject()
//            realm.add(realmToDoItem)
//        }
//    }
//
//    func updateToDoItem(toDoItem: ToDoList.ToDoItem) {
//        try! realm.write {
